...
_HERMES_BEHAVIORAL_VARS = frozenset({
    ...
    "DISCORD_STREAMING_DISABLED_CHANNELS",
    "DISCORD_RECENT_CONTEXT_CHANNELS",
    "DISCORD_RECENT_CONTEXT_LIMIT",
    "DISCORD_RECENT_CONTEXT_MAX_CHARS",
    "DISCORD_RECENT_CONTEXT_INCLUDE_BOTS",
    "BUZZER_QUEUE_ENABLED",
    "BUZZER_STATE_TTL_SECONDS",
